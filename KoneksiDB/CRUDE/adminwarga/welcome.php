            ...
            <li class="nav-item">
                ...
                <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item" href="tabel.php">UBAH</a>
                ...
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        ...
                        <a href="#" class="d-none d-sm-inline-block btn btn-sm btn-primary shadow-sm"><i
                                class="fas fa-download fa-sm text-white-50"></i> Tombol Hiasan</a>
                    </div>
                                    ...
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                            ...
                                            <div class="h5 mb-0 font-weight-bold text-gray-800">
                                                <?php
                                                    $jum = "select count(nama) from data_warga";
                                ...
                                <div class="card-body">
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                            ...
                                            <div class="h5 mb-0 font-weight-bold text-gray-800">
                                            <?php
                                                    $jum = "select count(username) from user";
                                                    $haj = $koneksi->query($jum);
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-6 mb-4">
                            ...
                            <div class="card shadow mb-4">
                                ...
                                <div class="card-body">
                                    ...
                                    <h4 class="small font-weight-bold">GameCube <span
                                            class="float-right">10%</span></h4>
                                    <div class="progress mb-4">
                                        <div class="progress-bar bg-info" role="progressbar" style="width: 10%"
                                            aria-valuenow="10" aria-valuemin="0" aria-valuemax="100"></div>
                                    </div>
                                    <h4 class="small font-weight-bold">XBox <span
                                    ...
                                    <h4 class="small font-weight-bold">Play Station 2 <span
                                            class="float-right">75%</span></h4>
                                    <div class="progress mb-4">
                                        <div class="progress-bar bg-info" role="progressbar" style="width: 75%"
                                            aria-valuenow="75" aria-valuemin="0" aria-valuemax="100"></div>
                                    </div>
                                    <h4 class="small font-weight-bold">Total Terjual <span
                                            class="float-right">209.870.420 Unit</span></h4>
                                    <div class="progress">
                        ...
                        <div class="col-lg-6 mb-4">
                            ...
                            <div class="card shadow mb-4">
                                <div class="card-header py-3">
                                    <h6 class="m-0 font-weight-bold text-primary">Seberapa Penting Warga</h6>
                                </div>
                                <div class="card-body">
                                    <div class="text-center">
                                        <img class="img-fluid px-3 px-sm-4 mt-3 mb-4" style="width: 25rem;"
                                            src="img/MONSTER.jpg" alt="...">
                                    </div>
                                    <p>Sebuah negara dapat berdiri dengan adanya warga. Tanpa warga maka negara tersebut hanya akan jadi mobil tanpa mesin. <a
                                            target="_blank" rel="nofollow" href="https://obluda.fandom.com/wiki/Monster_Wiki">Monster</a>, sebuah karya yang dibuat oleh Urasawa Naoki ini menceritakan tentang seberapa jauh manusia dapat berjalan tanpa memikirkan moral. Mulai dari kejahatan, kekacauan dan kengerian dari seorang nihilis sangat kental dalam cerita.</p>
                                    <a target="_blank" rel="nofollow" href="https://obluda.fandom.com/wiki/Monster_Wiki">Ketahui lebih dalam tentang MONSTER &rarr;</a>
                                </div>
                                </div>
                            </div>
                            ...
                            <div class="card shadow mb-4">
                                <div class="card-header py-3">
                                    <h6 class="m-0 font-weight-bold text-primary">Pentingnya Saling Mengenal</h6>
                                </div>
                                <div class="card-body">
                                <div class="text-center">
                                        <img class="img-fluid px-3 px-sm-4 mt-3 mb-4" style="width: 25rem;"
                                            src="img/BloodBorne.jpg" alt="...">
                                    </div>
